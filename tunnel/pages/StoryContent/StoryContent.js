        ...
        <div>
            ...
            <div className={styles.container}>
                ...
                <div className={`${styles.section} ${styles.normSection}`}>
                    ...
                    <p className={styles.words}>
                        By chance, just as he was about to leave the Hub, he spotted his roommates exit ahead of him. The sight of them broke his illusion that he was in a good place in his life and reminded him of the situation between him and his roommates. John contemplated talking to them this evening. But, because John made a new friend today, he had a bit of confidence. He felt invigorated.
                    </p>
                </div>
                <div className={`${styles.section} ${styles.normSection}`}>
                    <div className={styles.block}></div>
